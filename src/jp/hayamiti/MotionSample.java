...
public class MotionSample {
	...
	public static void sampleMotion(CRobotPose pose, CRobotMem mem, CSotaMotion motion) {
		CRobotUtil.Log(TAG, "Rev. " + mem.FirmwareRev.get());
	...
	public static void defaultPose(CRobotPose pose, CRobotMem mem, CSotaMotion motion) {
		CRobotUtil.Log(TAG, "Rev. " + mem.FirmwareRev.get());
...
//		motion.ServoOff();
	 ...
	 * @param motion
	 */
	public static void stragePose(CRobotPose pose, CRobotMem mem, CSotaMotion motion) {
